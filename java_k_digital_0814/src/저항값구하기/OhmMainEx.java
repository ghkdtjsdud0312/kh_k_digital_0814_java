...
public class OhmMainEx {
    public static void main(String[] args) {
        ...
        String firColor = sc.nextLine();
        String secColor = sc.nextLine();
        String thdColor = sc.nextLine();

       for(int i = 0; i < color.length; i++) {
           if(firColor.equals(color[i])) fir = i; // 첫번째 입력 받은 컬러 문자열의 인덱스 값을 구함 (10의 자리 값)
        ...
        System.out.println((long)((fir * 10) + sec) * (long)(Math.pow(10, thd)));
        }
    }
